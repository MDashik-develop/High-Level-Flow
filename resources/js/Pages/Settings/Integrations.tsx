                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {settings.map((setting) => {
                        ...
                        return (
                            <div
                                key={setting.id}
                                className="rounded-sm bg-[#0b1120] border border-slate-800 p-5 space-y-4 shadow-sm"
                            >
                                {/* Card Header */}
                                <div className="flex items-start justify-between pb-3 border-b border-slate-800">
                                    <div className="flex items-center gap-3">
                                        <div className="w-9 h-9 rounded-sm bg-slate-900 border border-slate-700 flex items-center justify-center font-bold text-white">
                                            {setting.provider === 'twilio' && <Phone className="w-4 h-4 text-amber-400" />}
                                            {setting.provider === 'resend' && <Mail className="w-4 h-4 text-sky-400" />}
                                            {setting.provider === 'stripe' && <DollarSign className="w-4 h-4 text-emerald-400" />}
                                            {setting.provider === 'openai' && <Sparkles className="w-4 h-4 text-purple-400" />}
                                            {setting.provider === 'calendly' && <Calendar className="w-4 h-4 text-blue-400" />}
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-sm text-white">{setting.name}</h3>
                                            <p className="text-[11px] text-slate-400 capitalize">Category: {setting.category}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-3 text-xs">
                                    {setting.provider === 'twilio' && (
                                        <>
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Account SID</label>
                                                <input
                                                    type="text"
                                                    value={creds['account_sid'] || ''}
                                                    onChange={(e) => handleCredentialChange('twilio', 'account_sid', e.target.value)}
                                                    placeholder="ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
                                                    className="w-full bg-[#070a12] border border-slate-700 rounded-sm px-2.5 py-1.5 text-white font-mono text-xs focus:outline-none focus:border-indigo-500"
                                                />
                                            </div>
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Auth Token</label>
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full bg-[#070a12] border border-slate-700 rounded-sm pl-2.5 pr-8 py-1.5 text-white font-mono text-xs focus:outline-none focus:border-indigo-500"
                                                    />
                                                    <button
                                                        type="button"
                                            ...
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Twilio Phone Number</label>
                                                <input
                                                    type="text"
                                    ...
                                    {setting.provider === 'resend' && (
                                        <>
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Resend / SendGrid API Key</label>
                                                <div className="relative">
                                                    <input
                                            ...
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Verified Sender Email</label>
                                                <input
                                                    type="email"
                                    ...
                                    {setting.provider === 'stripe' && (
                                        <>
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Publishable Key</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div>
                                                <label className="block text-slate-400 mb-1 font-medium">Secret Key</label>
                                                <div className="relative">
                                                    <input
                                ...
                                <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-xs">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            ...
                                            className="px-2.5 py-1 rounded-sm border border-slate-700 hover:bg-slate-800 text-slate-300 font-medium transition flex items-center gap-1"
                                        >
