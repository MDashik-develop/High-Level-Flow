                ...
                <div className="p-6 rounded-sm dark:bg-gradient-to-r dark:from-indigo-950/60 dark:via-[#0b1120] dark:to-[#0b1120] bg-gradient-to-r from-indigo-50 via-white to-white border dark:border-indigo-500/40 border-indigo-200 shadow-sm space-y-4">
                    <form onSubmit={handleScan} className="flex flex-col sm:flex-row items-center gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={scanning}
                            className="w-full sm:w-auto px-6 py-3 rounded-sm bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-sm transition whitespace-nowrap"
                        >
                            {scanning ? (
                                <>
                ...
                <div className="rounded-sm dark:bg-[#0b1120] bg-white border dark:border-slate-800 border-slate-200 shadow-sm overflow-hidden">
                    <div className="p-4 border-b dark:border-slate-800 border-slate-200 flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-[11px] dark:text-slate-400 text-slate-500">Prospect intelligence repository</p>
                        </div>
                    </div>
                            ...
                            <tbody className="divide-y dark:divide-slate-800/60 divide-slate-200 text-xs dark:text-slate-300 text-slate-700">
                                {audits.data.length === 0 ? (
                                    ...
                                    audits.data.map((audit) => (
                                        <tr key={audit.id} className="dark:hover:bg-slate-900/30 hover:bg-slate-50 transition">
                                            ...
                                            <td className="py-3.5 px-4 text-right">
                                                <Link
                                                    ...
                                                    className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-sm bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-600 dark:text-indigo-400 border border-indigo-500/30 text-xs font-semibold transition"
                                                >
